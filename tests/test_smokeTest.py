...
class TestSmokeTest():
  ...
  def test_badAuthenticationTest(self):
  ...
  def test_joinInputTest(self):
    ...
    self.driver.find_element(By.NAME, "bizname").send_keys("Test Name")
    self.driver.find_element(By.NAME, "biztitle").click()
    self.driver.find_element(By.NAME, "biztitle").send_keys("Sir")
